...
const MOCK_CHALLENGES: Challenge[] = [
  { id: '1', title: '5K Run', challenger: 'Alex', opponent: 'You', points: 20, status: 'active' },
  { id: '2', title: '30-Day Pushup Streak', challenger: 'Jordan', opponent: 'You', points: 50, status: 'pending' },
  { id: '3', title: 'No Sugar Week', challenger: 'You', opponent: 'Sam', points: 15, status: 'completed' },
];
...
export async function createChallenge(
  ...
  await fakeDelay();
  const challenge: Challenge = { id: Date.now().toString(), status: 'pending', ...newChallenge };
